onRecordUpdate((e) => {
  ...
  try {
    ...
    // Se ainda não achou, tentar pegar o primeiro admin ou usuário ativo do tenant
    ...
    // Regra padrão de comissionamento: 10% do valor do contrato (percentual padrão do escritório)
    ...
    console.log('Erro no hook de comissões:', err)
  }
}, 'contracts')
