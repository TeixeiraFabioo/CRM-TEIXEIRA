 ...
 *
 * Webhook Endpoints:
 * - GET  /backend/v1/whatsapp/webhook: Meta webhook verification challenge (responds hub.challenge in plain text after verifying hub.verify_token)
 * - POST /backend/v1/whatsapp/webhook: Inbound messages processing, lead auto-creation, lead messages recording, delivery status
 *
 * Lifecycle hooks:
...
// Rota OBRIGATÓRIA da plataforma: /backend/v1/whatsapp/webhook
